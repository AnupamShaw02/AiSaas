  ...
  return (
    <div className='fixed z-5 w-full baxkdrop-blur-2xl flex justify-between items-center py-3 px- sm:px-20 xl:px-32' >
...

      {
        ...
        : 
        (
            <button onClick={openSignIn} className='flex items-center gap-2 rounded-flll text-sm cursor-pointer bg-primary text-white px-10 py-2.5'>Get started <ArrowRight className='w-4 h-4'/> </button>
        )
      }
